...
import { usePreview, type PreviewFile } from "./file-preview";
 ...
 *  opening Quick Look (or downloading non-previewable kinds) on click. */
 ...
 */
export function makeWorkspaceComponents(chatId: string) {
  return {
    ...
    a({ href, children }: ComponentPropsWithoutRef<"a"> & { node?: unknown }) {
      ...
      if (rel) return <WorkspacePathChip rel={rel} chatId={chatId} />;
      return (
