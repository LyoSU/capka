 ...
 *    the mechanism.
 */
export function ThinkingPicker({ value, onChange, provider, reasoning, efforts, disabled }: ThinkingPickerProps) {
      ...
      <Popover>
        ...
        <PopoverContent side="top" align="end" className="w-64 p-3.5">
          ...
          <div className="group/track relative mt-2 h-7">
            ...
            <span
              aria-hidden
              className="pointer-events-none absolute top-1/2 size-7 -translate-x-1/2 -translate-y-1/2 rounded-full bg-card shadow-[0_1px_4px_rgb(0_0_0/0.16)] ring-1 ring-foreground/5 transition-[left,transform] duration-200 ease-[var(--ease-out)] group-active/track:scale-95 motion-reduce:transition-none"
