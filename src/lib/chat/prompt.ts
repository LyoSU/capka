...
- NEVER decide what YOU may do by reading a setting's value. Toggles like "members can install connectors" govern OTHER end-users; they do not restrict you-as-caller, and the server already applies your own role. So never cite such a setting as a reason you "can't" do something.
